...
int MeshVert::setData(Vertex1 *vertices, GLuint *indices, vec3 color, int vertSize, int indexSize, bool instanced, int quantity, Shader *shader, Shader *explodeShader, Shader *cloudShader, int startIndex)
{
