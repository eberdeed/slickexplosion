...
public:
     ...
     * startIndex the first valid available texture buffer.
     */
    Model(vector<ModelInfo> modelinfo, Shader *shader, Shader *explodeShader, Shader *cloudShader, int startIndex, int quantity);
     ...
     * model, view, projection : the Affine matrices defining
     * the location and viewing of the object.
     */
    void DrawExplosion(int index, mat4 model, mat4 view, mat4 projection);
protected:
    /*  Functions   */
