...
public:
    ...
    //! Euler Angles current and persistent.
     ...
     * upX, upY, upZ : the (x, y, z) direction of camera up.
     * yaw : yaw based on (0, y, z > 0) as zero radians.
     * pitch : pitch based on (x, 0, z) as zero radians.
     */
     ...
     */
    void getEulerAngles();
    /** \brief Calculate the forward vector from the Euler angles.
     */
    void getFront();
